...
const uint32_t TableStruct_geometry_5fmsgs_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::geometry_msg::Twist, linear_x_),
  PROTOBUF_FIELD_OFFSET(::geometry_msg::Twist, linear_y_),
  PROTOBUF_FIELD_OFFSET(::geometry_msg::Twist, linear_z_),
  PROTOBUF_FIELD_OFFSET(::geometry_msg::Twist, angular_x_),
  PROTOBUF_FIELD_OFFSET(::geometry_msg::Twist, angular_y_),
  PROTOBUF_FIELD_OFFSET(::geometry_msg::Twist, angular_z_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::geometry_msg::Twist)},
};
...
const ::_pbi::DescriptorTable descriptor_table_geometry_5fmsgs_2eproto = {
    false, false, 163, descriptor_table_protodef_geometry_5fmsgs_2eproto,
    "geometry_msgs.proto",
...
template<> PROTOBUF_NOINLINE ::geometry_msg::Twist*
Arena::CreateMaybeMessage< ::geometry_msg::Twist >(Arena* arena) {
  return Arena::CreateMessageInternal< ::geometry_msg::Twist >(arena);
}
